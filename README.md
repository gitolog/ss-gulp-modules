...
> gulp minify:js
```
Файл **_common.js_** в папке **_/www/javascript_** будет сжат и сохранен в эту же папку под именем **_common.min.js_**
...
> gulp build
```
Компиляция и сжатие CSS, JS и изображений с предварительным удалением предыдущей сборки.
