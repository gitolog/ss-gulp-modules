...
> gulp compile:js
```
Будут взяты все JS-файлы (сперва основные вендорные зависимости) из папки **_/www/javascript/src_**, скомпилированы, объединены в один файл и помещены в **_/www/javascript/common.js_**
